...
namespace ICSharpCode.SharpZipLib.Zip 
{
	...
	public enum UseZip64
	{
		...
		/// </summary>
		/// <remarks>An entry can have this overridden if required <see cref="MyZipEntry.ForceZip64"></see></remarks>
		Off,
		/// <summary>
	...
	public sealed class ZipConstants
	{
		...
		/// for an entry.  See <see cref="MyZipEntry.CanDecompress"/>.
		/// </remarks>
		...
		/// <remarks>
		/// This is also the Zip version for the library when comparing against the version required to extract
		/// for an entry.  See <see cref="MyZipInputStream.CanDecompressEntry">ZipInputStream.CanDecompressEntry</see>.
		/// </remarks>
