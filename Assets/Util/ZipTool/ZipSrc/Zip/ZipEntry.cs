...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// </summary>
	public class MyZipEntry : ICloneable
	{
		[Flags]
		enum Known : byte
		{
		...
		/// The name passed is null
		/// </exception>
		internal MyZipEntry(string name, int versionRequiredToExtract)
		...
		/// </remarks>
		internal MyZipEntry(string name, int versionRequiredToExtract, int madeByInfo,
		...
		public MyZipEntry(MyZipEntry entry)
		{
			if ( entry == null ) {
		...
		/// <summary>
		/// Test the external attributes for this <see cref="MyZipEntry"/> to
...
//				return (byte[]) extra.Clone();
		...
		/// The <see cref="MyZipInputStream"/> class doesnt have the comment data available.
		/// </remarks>
		...
		public object Clone()
		{
			MyZipEntry result = (MyZipEntry)this.MemberwiseClone();
		...
		/// </summary>
		/// <returns>A readable textual representation of this <see cref="MyZipEntry"/></returns>
