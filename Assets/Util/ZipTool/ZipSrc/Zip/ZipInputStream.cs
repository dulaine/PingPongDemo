...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	/// </code>
	/// </example>
	public class MyZipInputStream : InflaterInputStream
	{
		...
		public MyZipInputStream(Stream baseInputStream)
        ...
        public MyZipInputStream( Stream baseInputStream, int bufferSize )
		...
		/// </summary>
		/// <value>A password for all encrypted <see cref="MyZipEntry">entries </see> in this <see cref="MyZipInputStream"/></value>
		...
		/// See the <see cref="MyZipEntry.Version">ZipEntry Version</see> property for more details.
		/// </remarks>
		...
		/// </summary>
		/// <returns>
		/// The next <see cref="MyZipEntry">entry</see> in the archive or null if there are no more entries.
		/// </returns>
		/// <remarks>
		...
		public MyZipEntry GetNextEntry()
		{
			...
			entry = new MyZipEntry(name, versionRequiredToExtract);
			entry.Flags = flags;
