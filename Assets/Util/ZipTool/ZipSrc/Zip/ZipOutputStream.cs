...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class ZipOutputStream : DeflaterOutputStream
	{
		...
		/// If backwards compatability is an issue be careful when adding <see cref="MyZipEntry.Size">entries</see> to an archive.
		...
		/// </exception>
		public void PutNextEntry(MyZipEntry entry)
		{
			if ( entry == null ) {
...
#if !NET_1_1 && !NETCF_2_0
		private static void AddExtraDataAES(MyZipEntry entry, ZipExtraData extraData) {
		...
		//
		private void WriteAESHeader(MyZipEntry entry) {
			byte[] salt;
			byte[] pwdVerifier;
		...
		public override void Finish()
		{
			...
			foreach (MyZipEntry entry in entries) {
